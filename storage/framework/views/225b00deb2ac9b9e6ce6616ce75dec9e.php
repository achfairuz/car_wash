...
<body class="w-full" x-data="{ isOpen: window.innerWidth >= 1024, showLogoutModal: false }" x-init="window.addEventListener('resize', () => { isOpen = window.innerWidth >= 1024 })">
    ...
    <div class="h-screen flex overflow-hidden">
        ...
        <div :class="{
            ...
            <div class="mt-6 flex justify-between mx-4">
                <div class="img">
                    <img src="<?php echo e(asset('img/logo.png')); ?>" class="w-24" alt="logo">
                </div>
            ...
            <div
                ...
                <div class="img">
                    ...
                    <div class="text text-center mt-2 font-semibold  ">
                        <h1 class="text-xl font-bold "><?php echo e(session('username')); ?></h1>
            ...
            <nav class="mt-6 border-b-2 border-gray-600 mb-4 pb-2">
                <a href="<?php echo e(session('role') === 'admin' ? route('dashboard-admin') : route('dashboard-user')); ?>"
                    class="block py-2.5 px-4 mx-4 my-2 rounded transition duration-200 
    <?php echo e((session('role') === 'admin' && request()->routeIs('dashboard-admin')) ||
    (session('role') === 'user' && request()->routeIs('dashboard-user'))
        ...
        : 'hover:bg-gray-700 hover:text-white'); ?>">
                ...
                <a href="<?php echo e(session('role') === 'admin' ? route('services-admin') : route('services-user')); ?>"
                    class="block py-2.5 mx-4 px-4 my-2 rounded transition duration-200 
    <?php echo e((session('role') === 'admin' && request()->routeIs('services-admin')) ||
    (session('role') === 'user' && request()->routeIs('services-user'))
        ...
        : 'hover:bg-gray-700 hover:text-white'); ?>">
                ...
                <a href="<?php echo e(session('role') === 'admin' ? route('shop-admin') : route('shop-user')); ?>"
                    class="block py-2.5 mx-4 px-4 my-2 rounded transition duration-200 
    <?php echo e((session('role') === 'admin' && request()->routeIs('shop-admin')) ||
    (session('role') === 'user' && request()->routeIs('shop-user'))
        ...
        : 'hover:bg-gray-700 hover:text-white'); ?>">
                ...
                <a href="<?php echo e(route('manajemen-admin')); ?>"
                    class="block py-2.5 mx-4 px-4 my-2 rounded transition duration-200 <?php echo e(session('role') === 'user' ? 'hidden' : 'block'); ?>

    <?php echo e(session('role') === 'admin' && request()->routeIs('manajemen-admin')
        ? 'bg-gray-700 text-white'
        : 'hover:bg-gray-700 hover:text-white'); ?>">
                    Manajemen
                </a>
                ...
                <a href="<?php echo e(route('discounts-admin')); ?>"
                    class="block py-2.5 mx-4 px-4 my-2 rounded transition duration-200 <?php echo e(session('role') === 'user' ? 'hidden' : 'block'); ?>

    <?php echo e(session('role') === 'admin' && request()->routeIs('discounts-admin')
        ? 'bg-gray-700 text-white'
        : 'hover:bg-gray-700 hover:text-white'); ?>">
                    Discount
                </a>
        ...
        <div class="flex flex-col w-full transition-all duration-200">
            <header
                ...
                <a href="<?php echo e(session('role') === 'admin' ? route('carts-admin') : route('carts-user')); ?>">
                    <div
                        class="flex flex-row gap-2 <?php echo e(Request::routeIs('carts-admin') || Request::routeIs('carts-user') ? 'text-blue-300' : 'text-gray-800 dark:text-white'); ?>">
                        <span>Keranjang</span>
...
<?php /**PATH C:\DATASAYA\D\laragon\www\cuciMotor\resources\views/components/sidebar.blade.php ENDPATH**/ ?>