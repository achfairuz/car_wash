...
<?php $component->withAttributes([]); ?>
        ...
        <div class="swiper-container mx-auto"
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="<?php echo e(asset('img/bg section.jpg')); ?>" alt="Slide 1"
                        class="w-full h-full object-cover rounded-lg">
                </div>
                <div class="swiper-slide">
                    <img src="<?php echo e(asset('img/bg-login.jpg')); ?>" alt="Slide 2"
                        class="w-full h-full object-cover rounded-lg">
                </div>
                <div class="swiper-slide">
                    <img src="<?php echo e(asset('img/feedback.jpg')); ?>" alt="Slide 3"
                        class="w-full h-full object-cover rounded-lg">
                </div>
            </div>
            <!-- Add Pagination -->
    ...
    <div class="p-6 bg-white rounded-lg shadow-md mb-6 mx-2 md:mx-6">
        <!-- Section Title -->
        <h2 class="text-2xl font-semibold mb-4 text-gray-800">Welcome, <?php echo e(session('username')); ?>!</h2>
...
<?php endif; ?>
<?php /**PATH C:\DATASAYA\D\laragon\www\cuciMotor\resources\views/user/dashboard.blade.php ENDPATH**/ ?>