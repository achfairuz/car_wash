...
<x-layout>
    ...
    <section id="dashboard" class="py-32"
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            ...
            {{-- <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                ...
                <a href="#"
                    class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-slate-300 dark:hover:text-black dark:hover:bg-white dark:focus:ring-blue-800">
    ...
    <section id="slogan" class="bg-blue-700 py-20 dark:bg-blue-900">
        <div class="container mx-auto flex flex-col md:flex-row justify-center items-center lg:gap-56 md:gap-20 gap-16">
            <div class="content text-center">
                <img class="mx-auto" src="{{ asset('img/clean.png') }}" alt="Cleaning" draggable="false">
            ...
            <div class="content text-center">
                <img class="mx-auto" src="{{ asset('img/polish.png') }}" alt="Polishing" draggable="false">
            ...
            <div class="content text-center">
                <img class="mx-auto" src="{{ asset('img/vehiclecare.png') }}" alt="Vehicle Care" draggable="false">
    ...
    <section class="py-32 dark:bg-gray-900 bg-slate-200" id="about">
        <div class="container flex flex-wrap justify-center mx-auto gap-10 lg:gap-20">
            <div class="img mx-4">
                <img src="{{ asset('img/content about.jpg') }}" alt="about_content"
                ...
                <div class="title">
                    ...
                    <div class="foot-content mt-6">
                        <ul class="flex justify-start items-center space-x-2">
                            <li><img src="{{ asset('img/check2-circle.png') }}" alt="check" class="h-8"
                                    draggable="false"></li>
                            <li>
    ...
    <section class="bg-slate-200 dark:bg-gray-900 pt-10 pb-16  relative flex flex-col items-center" id='services'>
        ...
        <div class="mt-4 md:mt-8 lg:mt-10 flex justify-center w-full">
            <img src="{{ asset('img/service.jpg') }}" alt="service_content"
        ...
        <div
            ...
            <div
                ...
                <img src="{{ asset('img/motorcycle.png') }}" alt="motorcycle" draggable="false"
            ...
            <div
                ...
                <img src="{{ asset('img/car.png') }}" alt="car"
                ...
                <div class="body mt-14">
                    ...
                    <div class="subtitle max-w-sm mt-8">
                        ...
                        <ul class="flex items-center flex-wrap space-x-4 ml-4 mt-2">
                            <li>
                                <img src="{{ asset('img/calendar.png') }}" alt="calendar_icon" class="w-6 h-6"
                                    draggable="false">
                            </li>
                            <li>
    ...
    <section class="bg-slate-200 dark:bg-gray-900 py-20 animate-fadeIn">
        <div class="container mx-auto flex flex-wrap justify-center gap-10">
            ...
            <div class="hidden lg:block lg:max-w-xs md:max-w-md">
                <img src="{{ asset('img/feedback.jpg') }}" alt="feedback_image" class="w-full rounded-md shadow-md">
            </div>
        </div>
    </section>
